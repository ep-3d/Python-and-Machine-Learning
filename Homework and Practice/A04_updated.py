...
def main():
	...
	while choice != 4:
		...
		# in the future pass favlist as an parameter
		elif choice == 3:
...
def validate_zip_code(zip_code):
    ...
    try:
        ...
        if data_valzip.get("results"):
            ...
            return zip_code == postal_code   # Should return as True
        else:
            return False
        ...
        print(f"The provided zip code {zip_code} was not found in the response.")
